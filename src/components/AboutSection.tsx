...
const AboutSection = () => {
  ...
  return <section id="sobre" ref={sectionRef} className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">A TOTALLOG - Transitário é uma empresa de referência no setor de Importação e Exportação, com forte presença nacional e internacional. Somos especialistas em soluções completas de despachos aduaneiros e logística, oferecendo serviços eficientes, seguros e sustentáveis.<strong className="text-foreground">TOTALLOG - Transitário</strong> é uma empresa de referência no setor de Importação e Exportação,
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">Atuamos com foco na qualidade, transparência e excelência em cada etapa do processo aduaneiro e  logístico, garantindo a satisfação dos nossos clientes e parceiros. Valorizamos a excelência operacional, a inovação e o desenvolvimento contínuo das nossas equipas.</p>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => <div key={index} className="card-service text-center group" style={{
