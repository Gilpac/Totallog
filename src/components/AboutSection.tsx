...
const stats = [
  ...
  { icon: Users, value: "1000+", label: "Clientes" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Atuamos com foco na qualidade, transparência e excelência em cada etapa do processo logístico, 
              garantindo a satisfação dos nossos clientes e parceiros. Valorizamos a excelência operacional, 
              a inovação e o desenvolvimento contínuo das nossas equipas.
            </p>
